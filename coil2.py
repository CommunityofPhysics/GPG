'''
    ...
    Solve iteratively the co-efficients for 2N parameters
    ...
    for L in range(1, p + 1):
        for i in range(1, n + 1):
            ...
            for k in range(0, L + 1):
                ...
                col_1 += const * pow(Si, 2*k)
                col_2 += const * Ui * (2*k) * pow(Si, 2*k-1)
...
print("2nd N values of the solution corresponds to S variable")
print()
